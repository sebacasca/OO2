...
public class ClienteABM {
	...
	public int agregar(String apellido, String nombre, int dni,GregorianCalendar fechaDeNacimiento, double ingreso) throws Exception{
		
		Cliente c=new Cliente(apellido, nombre, dni,fechaDeNacimiento, ingreso);
